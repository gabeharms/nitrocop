...
- **NEVER run `git checkout -- .` or `git restore .` on a shared branch.** Other agents may have uncommitted work in the working tree. Resetting all files destroys their progress. Only checkout/restore specific files that you own.
